...
//LT33222-L or LT22222-L Decode   
  ...
  {  
    ...
    if(hardware=='0')
    {
      ...
      decode.Node_type="LT-33222-L";
      decode.DO3_status=(bytes[8] &0x04)? "Low":"High";
      if(mode0=='1')
      {
      	decode.DI3_status= (bytes[8] &0x20)?"High":"Low"; 
      }
    }
    else if(hardware=='1')
    {
      decode.Node_type="LT-22222-L";
      decode.Hardware_mode= "LT22222";
    }
    
    if(mode!=6)
    {
      decode.DO1_status= (bytes[8] &0x01)? "Low":"High";
      decode.DO2_status= (bytes[8] &0x02)? "Low":"High";
    ...
    if(mode=='1')
    {
      ...
      decode.DI1_status= (bytes[8] &0x08)? "High":"Low";
      decode.DI2_status= (bytes[8] &0x10)? "High":"Low";
    }
    else if(mode=='2')
    {
